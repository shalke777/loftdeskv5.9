...
// Portal-side responses go through portal-project.api.ts → portal_respond_approval().
//
// Key rules:
...
//  - Client sees approvals via RLS on project_client_access (migration 042+051)
