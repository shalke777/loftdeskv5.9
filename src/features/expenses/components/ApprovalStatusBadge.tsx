...
const STATUS_CONFIG: Record<ApprovalStatus, { label: string; icon: string; color: string; bg: string }> = {
  pending_client: { label: 'Oczekuje na klienta', icon: '⏳', color: 'var(--color-accent)', bg: 'rgba(212,150,10,0.15)' },
  accepted:       { label: 'Zaakceptowany',        icon: '✅', color: 'var(--color-brand)', bg: 'rgba(26,92,50,0.18)' },
  rejected:       { label: 'Odrzucony',            icon: '❌', color: 'var(--color-error)', bg: 'rgba(239,68,68,0.12)' },
  questioned:     { label: 'Klient ma pytanie',    icon: '❓', color: 'var(--color-info)', bg: 'rgba(96,165,250,0.15)' },
