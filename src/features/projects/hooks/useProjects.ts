...
export function useCreateProject() {
  ...
  return useMutation({
    ...
    onSuccess(data, _vars, context) {
      ...
      // Invalidate billing so project count and limit are refreshed immediately
