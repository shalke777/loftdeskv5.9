...
export function PortalEstimate({
  ...
  return (
    ...
    >
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, marginBottom: 16 }}>
          <thead>
            <tr style={{ borderBottom: '2px solid #e5e7eb' }}>
              ...
              <th style={{ textAlign: 'right', padding: '4px 8px', fontWeight: 600, color: '#6b7280' }}>Ilość</th>
      ...
      {validUntil && (
        <p style={{ fontSize: 12, color: '#94a3b8', marginBottom: 16 }}>Ważna do: {validUntil}</p>
      )}
      ...
      >
        <div style={{ fontWeight: 700, fontSize: 16 }}>
          ...
          zł <span style={{ fontSize: 12, fontWeight: 400, color: '#94a3b8' }}>(brutto)</span>
        </div>
