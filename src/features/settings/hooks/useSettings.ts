...
export function useUpdateCompanyProfile() {
  ...
  return useMutation({
    mutationFn: (input: { company_name: string; nip?: string; address?: string; postal_code?: string; city?: string; iban?: string; phone?: string; email?: string; ksef_env: 'test' | 'prod'; ksef_nip: string; ksef_token: string; logo_url?: string | null }) => settingsApi.updateProfile(companyId, input),
    onSuccess: async () => {
